      ...
      <BalancedLayout className="relative z-10">
        ...
        >
          <div className="mb-4 inline-flex items-center px-4 py-1.5 bg-[#27AE60]/10 rounded-full">
            ...
            <span className="text-sm font-medium text-[#27AE60] uppercase tracking-wider">
              Ẩm thực đặc sắc
            </span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            <span className="text-[#212529]">ẨM THỰC </span>
            <span className="text-[#27AE60]">PHONG PHÚ</span>
          </h2>
